...
import FlagEN from '../../public/medias/images/flag-england.png';
import FlagFR from '../../public/medias/images/flag-french.png';
        ...
        <header id='header' className="flex items-center justify-between xl:pt-10">
            ...
            <div className="font-secondary">
                <nav className="flex items-center space-x-10">
                    <div className='flex'>
                        <a href="#projects" className="animate text-primary hover:text-primary/70 lg:flex">
                    ...
                    <div className='flex'>
                        <a href="#skills" className="animate text-black hover:text-black/70 lg:flex dark:text-yellow dark:hover:text-hover-yellow">
                            <span className='mr-1 flex'>
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-8 h-8 lg:w-6 lg:h-6">
                    ...
                    <div className='flex'>
                        <a href="#contact" className="animate text-primary hover:text-primary/70 lg:flex">
                            <span className='mr-1 flex'>
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-8 h-8 lg:w-6 lg:h-6">
                    ...
                    <div className="relative">
                        <button
                            ...
                            className="flex items-center space-x-2 bg-primary text-white px-3 py-2 rounded-full focus:outline-none"
                        >
                            <img src={i18n.language === 'en' ? FlagEN : FlagFR} className="w-7 h-5 rounded-full" alt="current language flag" />
                        ...
                        {isDropdownOpen && (
                            <div className="absolute right-0 mt-2 w-32 bg-white rounded-lg shadow-lg z-10">
                                <button
                                    ...
                                    className="animate flex items-center w-full p-2 rounded-lg hover:bg-gray"
                                >
                                    <img src={FlagEN} className="w-7 h-5 rounded-full mr-2" alt="English flag" />
                                    <span>English</span>
                                </button>
                                <button
                                    onClick={() => {
                                    ...
                                    className="animate flex items-center w-full p-2 rounded-lg hover:bg-gray"
                                >
                                    <img src={FlagFR} className="w-7 h-5 rounded-full mr-2" alt="French flag" />
                                    <span>Français</span>
                                </button>
                            </div>
                        )}
