  ...
  return (
    <div className='bg-black max-w-6xl mx-auto p-10 rounded-lg flex items-center justify-between'>
        <p className=' space-y-3 tracking-wider'>
            ...
            <span className='text-primary text-3xl font-tertiary'> Claire Holmaërt</span>
            ...
            <button className='bg-primary px-5 py-3 rounded-lg text-xl font-primary tracking-widest'>Contactez-moi</button>
        </p>
