...
function Presentation() {
  return (
    <div className='bg-black max-w-6xl mx-auto p-10 rounded-lg flex items-center justify-between'>
      ...
      <p className=' space-y-5 tracking-wider'>
            <span className='text-white font-secondary'>
            Salut, je m'appelle
            </span>
            <span className='text-primary text-4xl font-tertiary tracking-wider'> Claire Holmaërt</span>
        ...
        <a href="#contact" className='mt-5 w-48 animate bg-yellow hover:bg-hover-yellow hover:animate px-5 py-3 rounded-lg text-xl font-primary tracking-widest'>
            Contactez-moi
          </a>
      </div>
